...
?>
	...
	<div class="panel panel-info">
		<div class="panel-heading"><h3 style="margin-top: 5px"><span class="glyphicon glyphicon-user"></span> Beasiswa Pemkab</h3></div>
	</div>
	
	<form action="<?php echo base_URL()?>admin/beasiswa_pemkab/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<tr><td colspan="2">
		...
		<a href="<?php echo base_URL()?>admin/beasiswa_pemkab" tabindex="10" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>      
