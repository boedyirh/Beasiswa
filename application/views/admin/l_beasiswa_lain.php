...
<div class="panel panel-info">
	<div class="panel-heading" style="overflow: auto">
		<div class="col-md-3"><h3 style="margin-top: 5px"><span class="glyphicon glyphicon-user"></span> Beasiswa Lain</h3></div>
		<div class="col-md-2">
			<a href="<?php echo base_URL(); ?>admin/beasiswa_lain/add" class="btn btn-info"><i class="icon-plus-sign icon-white"> </i> Tambah Data</a>
		</div>
		<div class="col-md-3"></div>
		<div class="col-md-4">
			<form class="navbar-form navbar-left" method="post" action="<?php echo base_URL(); ?>admin/beasiswa_lain/cari" style="margin-top: 0px">
  ...
  <table class="display table table-bordered table-striped table-condensed table-hover" id="suratMasuk">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $b->isi_ringkas."<br><b>File : </b><i><a href='".base_URL()."upload/inter_office/".$b->file."' target='_blank'>".$b->file."</a>"?></td>
			...
			<td class="text-center" class="ctr" >
				...
				?>
				<div class="btn-group">
					<a href="<?php echo base_URL()?>admin/beasiswa_lain/edt/<?php echo $b->id?>" class="btn btn-success btn-sm" title="Edit Data"><i class="icon-edit icon-white"> </i> Edt</a>
					<a href="<?php echo base_URL()?>admin/beasiswa_lain/del/<?php echo $b->id?>" class="btn btn-warning btn-sm" title="Hapus Data" onclick="return confirm('Anda Yakin..?')"><i class="icon-trash icon-remove">  </i> Del</a>			
