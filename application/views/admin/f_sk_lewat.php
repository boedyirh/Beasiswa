...
?>
   ...
   ?>
  	...
  	<tr><td width="25%">Nomer SK</td><td><b><input type="text" name="NoSK" id="NoSK" tabindex="2"  required value="<?php echo $NoSK;   ?>"  style="width: 400px" class="form-control"></b></td></tr>		
    	...
    	<tr><td width="25%">Keterangan</td><td><b><input type="text" name="Keterangan" id="Keterangan" tabindex="2"  required value="<?php echo $Keterangan;   ?>"  style="width: 400px" class="form-control"></b></td></tr>		
